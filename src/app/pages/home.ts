...
@Component({
  ...
  template: `
    <section class="relative overflow-hidden">
      ...
      <header class="relative z-10 border-b border-slate-200/70 dark:border-slate-800/70 bg-white/70 dark:bg-slate-950/50 backdrop-blur">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <nav class="hidden md:flex items-center gap-1">
            ...
            <a routerLink="/playground" class="btn-ghost">Playground</a>
            <a routerLink="/playground" class="btn-primary ml-2">Launch App</a>
          </nav>
        </div>
      </header>

      <main class="relative z-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-16 sm:pb-24">
...
// • Citations you can trust
      ...
      <footer class="relative z-10 border-t border-slate-200/70 dark:border-slate-800/70 mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between text-sm text-slate-500">
          <p>© {{ new Date().getFullYear() }} Skunk AI</p>
